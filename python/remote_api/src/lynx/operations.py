...
def findSteinerTree(ename, vname, pname, rname, edge_costs, root_costs, gain):
  ...
  https://en.wikipedia.org/wiki/Steiner*tree*problem#Steiner*tree*in*graphs*and_variants[Prize-collecting Steiner Tree Problem].
...
def trainADecisionTreeClassificationModel(
  ...
  :param impurity:   Node impurity is a measure of homogeneity of the labels at the node and is used
    ...
    +
      ...
      let _f~i~_ be the ratio of the *i* th label in *S*. The entropy of the node is
