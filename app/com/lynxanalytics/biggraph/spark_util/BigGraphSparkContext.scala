...
class BigGraphKryoRegistrator extends KryoRegistrator {
  ...
  override def registerClasses(kryo: Kryo): Unit = {
    ...
    kryo.register(classOf[org.apache.spark.sql.catalyst.expressions.NullsFirst$])
    kryo.register(classOf[com.lynxanalytics.biggraph.graph_operations.EdgeAndNeighbor])
    kryo.register(classOf[Array[com.lynxanalytics.biggraph.graph_operations.EdgeAndNeighbor]])
