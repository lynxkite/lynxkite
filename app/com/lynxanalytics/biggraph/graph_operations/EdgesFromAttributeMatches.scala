...
object EdgesFromAttributeMatches extends OpFromJson {
  ...
  def fromJson(j: play.api.libs.json.JsValue) = EdgesFromAttributeMatches[Any]()
}
...
object EdgesFromBipartiteAttributeMatches extends OpFromJson {
  ...
  def fromJson(j: play.api.libs.json.JsValue) = EdgesFromBipartiteAttributeMatches[Any]()
}
