...
abstract class Operation(originalTitle: String, context: Operation.Context, val category: Operation.Category) {
  ...
  protected def hasBelongsToLinks = FEStatus.assert(project.asSegmentation.scalars("!belongsToEdges").value != null,
    "No segmentation links.")
  protected def hasNoBelongsToLinks = FEStatus.assert(project.asSegmentation.scalars("!belongsToEdges").value == null,
