...
import com.lynxanalytics.lynxkite.scala_sandbox.ScalaScriptSecurityManager
...
class BigGraphKryoRegistrator extends KryoRegistrator {
  ...
  override def registerClasses(kryo: Kryo): Unit = {
    ...
    kryo.register(classOf[com.lynxanalytics.lynxkite.spark_util.CountOrdering[_]])
    kryo.register(classOf[com.lynxanalytics.lynxkite.graph_util.HadoopFile])
    ...
    kryo.register(classOf[com.lynxanalytics.lynxkite.graph_operations.EdgesAndNeighbors])
    ...
    kryo.register(classOf[com.lynxanalytics.lynxkite.graph_operations.HyperVertex])
    kryo.register(classOf[Array[com.lynxanalytics.lynxkite.graph_operations.HyperVertex]])
    kryo.register(classOf[Array[List[_]]])
    kryo.register(classOf[com.lynxanalytics.lynxkite.graph_operations.ProbabilityOrdering])
      ...
      sparkConf = sparkConf
        ...
        .set(
          ...
          if (forceRegistration)
            "com.lynxanalytics.lynxkite.spark_util.BigGraphKryoForcedRegistrator"
          else "com.lynxanalytics.lynxkite.spark_util.BigGraphKryoRegistrator",
        )
    }
    if (master != "") {
