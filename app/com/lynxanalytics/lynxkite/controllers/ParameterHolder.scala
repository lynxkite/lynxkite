...
import com.lynxanalytics.lynxkite.scala_sandbox.SimpleGraphEntity
...
class ParameterHolder(context: Operation.Context) {
  ...
  def apply(name: String): String = {
    if (context.box.parametricParameters.contains(name)) {
      ...
      val evaluator = com.lynxanalytics.lynxkite.scala_sandbox.ScalaScript.compileAndGetEvaluator(expr, paramTypes)
