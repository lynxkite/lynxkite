...
import com.lynxanalytics.lynxkite.serving.{AccessControl, User, Utils}
import java.io.File
...
object ProjectViewer {
  ...
  def feTypeName[T](typeTag: TypeTag[T]): String = {
    typeTag.tpe.toString
      .replace("com.lynxanalytics.lynxkite.graph_api.", "")
      .replace("com.lynxanalytics.lynxkite.model.", "")
