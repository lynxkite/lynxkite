...
module.exports = function(fw) {
  fw.transitionTest(
    ...
    function() {
      lib.workspace.addBox({id: 'ex0', name: 'create example graph', x: 300, y: 100});
      lib.workspace.addBox({
        id: 'pr1', name: 'compute pagerank', x: 300, y: 200, after: 'ex0',
        params: { name: 'page_rank_default' } });
      lib.workspace.addBox({
        id: 'pr2', name: 'compute pagerank', x: 300, y: 300, after: 'pr1',
