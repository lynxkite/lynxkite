...
Just use the following configurations to set up LDAP authentication.
...
# export LDAP_URL=
```
The authentication method, e.g. `simple` or `DIGEST-MD5` as explained
http://docs.oracle.com/javase/jndi/tutorial/ldap/security/index.html[here] and
http://docs.oracle.com/javase/jndi/tutorial/ldap/security/sasl.html[here].
```
# export LDAP_AUTHENTICATION=
```
