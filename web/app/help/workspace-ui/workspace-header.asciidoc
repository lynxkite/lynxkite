...
Creates a custom box of the selected boxes. Only available if at least one box is selected. The custom
box will be saved under the specified full path.
include::../operations/glossary.asciidoc[tag=full-lk-path]

+++<label class="btn btn-default"><i class="fa fa-code"></i></label>+++ Save as Python code::
...
+++<label class="btn btn-default"><i class="fa fa-arrows"></i></label>+++ Pan workspace on drag::
