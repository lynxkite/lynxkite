...
+
Note that sometimes a single large community (besides many small ones) is generated.
Increasing this threshold above a certain level gets rid of the single large community.
====
