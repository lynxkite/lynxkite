...
### +++<div class="operation-toolbox" style="display: inline-block;"><div class="categories"><div class="category pink"><i class="fa fa-wrench"></i></div></div></div>+++ Manage graph

Utility features to manage and personalize graphs by manipulating (discarding, copying, renaming, etc.) attributes, scalars and segmentations. Example:
...
include::copy-scalar-from-other-graph.asciidoc[]
...
include::link-graph-and-segmentation-by-fingerprint.asciidoc[]
