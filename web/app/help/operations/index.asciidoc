...
### +++<div class="operation-toolbox" style="display: inline-block;"><div class="categories"><div class="category pink"><i class="glyphicon glyphicon-bishop"></i></div></div></div>+++ Machine learning operations

These operations perform machine learning on vertex attributes. A machine learning model is trained on
a set of data, and it can perform prediction or classification on a new set of data. For example, a logistic
regression model can be trained by the operation <<train-a-logistic-regression-model>> and it can classify
new data with the operation <<classify-vertices-with-a-model>>. There are three types of machine learning on
LynxKite. Regression can be used to predict numeric attributes, classification can be used to predict nominal
attributes and clustering can discover structures of the data. The following machine learning methods are
currently supported.
...
include::create-segmentation-from-sql.asciidoc[]
