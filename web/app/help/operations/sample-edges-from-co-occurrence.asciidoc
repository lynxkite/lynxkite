...
Connects vertices in the parent project with a given probability
...
[.gui-only]
--
There are +++<value ref="scalars['num_total_edges']"></value>+++ edges to sample from
including parallel edges.
--

====
[probability] Vertex pair selection probability::
