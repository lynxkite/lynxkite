...
The name of the attribute which shows which vertices belong to the sample. The attribute is not added to
the project if the name is an emtpy string.

[[edgeattrname]] Edge attribute name::
The name of the attribute which shows which edges belong to the sample. The attribute is not added to
the project if the name is an emtpy string.
