...
- If true the new attribute will only be defined on vertices for which all the attributes used in the
  expression are defined.
- If false the new attribute is defined on all vertices. In this case the JavaScript expression needs
