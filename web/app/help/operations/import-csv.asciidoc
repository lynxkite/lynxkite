...
Every line beginning with this character is skipped, if set. For example if the commen character is
`#` the following line is ignored in the CSF file: `# This is a comment.`
