...
[p-seed]#Random seed for test set selection#::
Random seed.
+
include::{g}[tag=random-seed]

[p-max_deviation]#Maximal segment deviation#::
...
[p-min_num_defined]#Minimum number of defined attributes in a segment#::
...
[p-min_ratio_defined]#Minimal ratio of defined attributes in a segment#::
