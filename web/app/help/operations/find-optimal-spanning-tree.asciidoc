...
====
[p-name]#Save as#::
The new edge attribute will be created under this name. Edges that make up the
tree are marked by 1 and the edges that are not part of the tree are marked by 0.
