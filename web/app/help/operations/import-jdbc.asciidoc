...
+
The last example is called "predicate pushdown", because the query in the parentheses
runs on the source database, before the import. It can dramatically reduce network
