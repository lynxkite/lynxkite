...
Clicking on the _"Visualize"_ button in the <<State popups>> opens the project visualization screen. You can choose to open the <<Concrete vertices view>> or the <<Bucketed view>>.

There are multiple types of graph visualizations, but in every case you see some objects connected by
some arcs.
