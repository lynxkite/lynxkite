    ...
    val project = box("Create example graph")
      .box(
        ...
        Map(
          ...
          "id_column" -> "name",
          "prefix" -> "imported"),
        Seq(importCSV("import-vertex-attributes.csv")))
      .project
    assert(project.vertexAttributes("imported_favorite_color").rdd.collect.toSeq.sortBy(_._1) ==
      Seq(0 -> "green", 1 -> "yellow", 2 -> "red", 3 -> "the color of television, tuned to a dead channel"))
  }
    ...
    val project = box("Create example graph")
      .box(
        ...
        Map(
          ...
          "id_column" -> "comment",
          "prefix" -> "imported"),
        Seq(importCSV("import-edge-attributes.csv")))
      .project
