    ...
    val project = box("Create example graph")
      ...
      .box(
        ...
        Map(
          ...
          "seg_id_attr" -> "name",
          "seg_id_column" -> "dst"),
        Seq(importCSV("fingerprint-example-connections.csv")),
      )
      .box(
  ...
  test("Fingerprinting between project and segmentation by attribute") {
    val other = box(
      ...
      Map(
        "src" -> "src",
        "dst" -> "dst"),
      Seq(importCSV("fingerprint-edges-2.csv")))
      .box(
    ...
    val golden = box(
      ...
      Map(
        "src" -> "src",
        "dst" -> "dst"),
      Seq(importCSV("fingerprint-edges-1.csv")))
      .box(
        "Use other graph as segmentation",
        Map(
          "name" -> "other"),
