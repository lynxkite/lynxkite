...
class SegmentByGEODataTest extends FunSuite with TestGraphOp {
  test("segment the ExampleGraph by GEO data") {
    ...
    val op = SegmentByGEOData(shapePath, 0.1, shapeFile.attrNames)
