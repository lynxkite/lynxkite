...
# Add S3 support.
SPARK_DIST_CLASSPATH_TMP=\$(find /usr/share/aws/emr/emrfs/lib -name "*.jar" | tr '\n' ':')\$(find /usr/share/aws/aws-java-sdk -name "*.jar" | tr '\n' ':')\$(find /usr/share/aws/emr/emr-metrics/lib -name "*.jar" | tr '\n' ':')
export SPARK_DIST_CLASSPATH=\$SPARK_DIST_CLASSPATH:\${SPARK_DIST_CLASSPATH_TMP::-1}
