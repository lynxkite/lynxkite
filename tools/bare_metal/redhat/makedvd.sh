...
# Get Cloudera.
wget --directory-prefix="$BUILD/" \
  'http://archive-primary.cloudera.com/cm5/cm/5/cloudera-manager-el6-cm5.4.7_x86_64.tar.gz'
wget --directory-prefix="$BUILD/" \
  'http://archive.cloudera.com/cdh5/parcels/5.4.7/CDH-5.4.7-1.cdh5.4.7.p0.3-el6.parcel'
wget --directory-prefix="$BUILD/" \
  'http://archive.cloudera.com/cdh5/parcels/5.4.7/CDH-5.4.7-1.cdh5.4.7.p0.3-el6.parcel.sha1'
wget --directory-prefix="$BUILD/" \
  'http://archive.cloudera.com/cdh5/parcels/5.4.7/manifest.json'
